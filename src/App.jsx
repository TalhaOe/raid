...
function RaidVisual({ level }) {
  ...
  if (id === "7") return <motion.div className="rounded-3xl bg-gradient-to-br from-yellow-50 to-orange-50 p-5 ring-1 ring-amber-200" whileHover={{ scale: 1.02 }}>
    ...
    <div className="rounded-2xl bg-amber-100 p-3 text-sm font-bold text-amber-900 ring-1 ring-amber-200">Zweck im Referat: als historisch/proprietär erwähnen, nicht als typisches modernes RAID empfehlen.</div>
  </motion.div>;
